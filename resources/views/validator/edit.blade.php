        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('validator.update', $data->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="prepared" name="prepared"
                                        ...
                                        value="{{ old('prepared', $data->prepared_by) }}" required>
                                    @error('prepared')
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="checked" name="checked"
                                        ...
                                        value="{{ old('checked', $data->checked_by) }}" required>
                                    @error('checked')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="approved" name="approved"
                                        ...
                                        value="{{ old('approved', $data->approved_by) }}" required>
                                    @error('approved')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
