...
<form action="{{ route('update_debit_note') }}" method="POST">
    @csrf
     ...
     <div class="row mt-5">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="date" name="invoice_date" value="{{ \Carbon\Carbon::parse($data->invoice_date)->format('Y-m-d') }}" class="form-control mt-1">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <strong>Tax Invoice Serial No</strong>
                <input type="text" name="tax_invoice_serial_no" value="{{ $data->tax_invoice_serial_no}}" class="form-control mt-1">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <strong>Tax Invoice Date</strong>
                <input type="date" name="tax_invoice_date" value="{{ \Carbon\Carbon::parse($data->tax_invoice_date)->format('Y-m-d') }}" class="form-control mt-1">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="received_bank" value="{{$data->received_bank}}" class="form-control mt-1">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
        ...
        <div class="col-md-6">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" name="wht" {{$data->wht}} class="form-control mt-1"  step=0.01 aria-describedby="inputGroupPrepend" >
         ...
         <div class="col-md-6">
            ...
            <input type="text" value="{{$data->received_from}}" class="form-control" name="received_from" class="form-control mt-1">
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <strong>Debit Note Date</strong>
                <input type="date" value="{{ \Carbon\Carbon::parse($data->debit_note_date)->format('Y-m-d') }}" name="debit_note_date" class="form-control mt-1" readonly>
            </div>
        </div>
    </div>
