                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h4 class="card-title">{{ $title }} {{ $payment->no_pr }}</h4>
                            <a href="{{ route('payment.download', $payment->id) }}" class="btn btn-primary btn-round ml-auto"
                                target="_blank">
                            ...
                            <table style="border-collapse:collapse;border:none; margin-left: auto;margin-right: auto;">
                                <tbody>
                                    <tr>
                                        <td colspan="9"
                                            ...
                                            <div class="pd-header">
                                                ...
                                                <span
                                                    style="font-family:'Times New Roman', serif;float: right;margin-right: 5pt;">PAYMENT
                                                    REQUEST</span>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3"
                                            style="border: none;padding: 0mm;height: 11pt;vertical-align: middle;">
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <span
                                                class="pd-small">{{ date('d-M-y', strtotime($payment->invoice_date)) }}</span>
                                        </td>
                                        <td colspan="3"
                                            style="border-top: none;border-bottom: none;border-left: none;border-image: initial;border-right: 1pt solid black;padding: 0mm;height: 9.55pt;vertical-align: middle;">
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <span
                                                class="pd-small">{{ $payment->due_date < 1 ? 'ASAP' : $payment->due_date }}
                                            </span>
                                        </td>
                                        <td
                                            ...
                                            <span
                                                class="pd-small">{{ date('d-M-y', strtotime($payment->deadline)) }}</span>
                                        </td>
                                        <td colspan="2"
                                        ...
                                        <td
                                            style="text-align: right;border-top: none;border-left: none;border-bottom: 1pt solid black;border-right: 1pt solid black;padding: 0mm;height: 9.6pt;vertical-align: middle;">
                                            <span
                                                class="pd-small">{{ date('d-M-y', strtotime($payment->received_date)) }}</span>
                                        </td>
                                        <td colspan="3"
                                    ...
                                    <tr>
                                        <td style="height: 1pt;border-left:1pt solid black;border-bottom:1pt solid black;"
                                            colspan="3">
                                        </td>
                                        <td colspan="2"></td>
                                        <td style="height: 1pt;border-right:1pt solid black;border-bottom:1pt solid black;"
                                            colspan="1">
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="2"
                                            style="border-left: 1pt solid black;border-right: 1pt solid black;">
                                        </td>
                                        <td colspan="1"
                                            style="border-left: 1pt solid black;border-right: 1pt solid black;">
                                        </td>
